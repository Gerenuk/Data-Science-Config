...
c.InteractiveShellApp.extensions = ["autoreload", "blackcellmagic"]
...
# 'all', 'last', 'last_expr', 'last_expr_or_assign' or 'none', specifying which nodes should be run
...
# c.InteractiveShell.banner1 = 'Python 3.4.5 |Anaconda custom (64-bit)| (default, Jul  2 2016, 17:47:47) \nType "copyright", "credits" or "license" for more information.\n\nIPython 5.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
# algol_nu, manni, vs, friendly, autumn, vim, pastie, igor, bw, perldoc, emacs,
# borland, native, murphy, lovelace, trac, fruity, algol, colorful, default,
# xcode, monokai, paraiso-dark, tango, rrt
